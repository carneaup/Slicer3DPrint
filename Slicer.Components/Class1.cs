...
namespace _3DPSlicing
{
    public class DPSlicingComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DPSlicingComponent()
          : base("3DPSlicing", "Nickname",
              "Description",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (Curve l in layers)
            {
                l.DivideByCount(m, false, out nodes[0]);
            }
        }
